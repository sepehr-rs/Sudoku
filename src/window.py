...
class SudokuWindow(Adw.ApplicationWindow):
    ...
    def _show_difficulty_dialog(self):
        ...
        for difficulty_label, difficulty in difficulties:
            ...
            button.connect("clicked", partial(self.on_difficulty_selected, difficulty, difficulty_label))
            box.append(button)

        dialog.show()

    def on_difficulty_selected(self, difficulty: float, difficulty_label : str, button: Gtk.Button):
        """Handle difficulty selection."""
        self.sudoku_window_title.set_subtitle(f"Difficulty {difficulty_label}")
